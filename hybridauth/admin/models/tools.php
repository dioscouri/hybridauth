...
class HybridAuthModelTools extends HybridAuthModelBase 
{	
    protected function _buildQueryWhere(&$query)
    {
		...
		$query->where("LOWER(tbl.folder) = 'hybridauth'");
	...
	public function getList($refresh = false)
	{
		if ($list = parent::getList($refresh))
		{
		    ...
		    {
		        $item->link = 'index.php?option=com_hybridauth&view=tools&task=view&id='.$item->id;
		    }
		} 
		return $list;
	}

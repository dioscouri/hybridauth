<?php defined('_JEXEC') or die('Restricted access'); ?>
	...
	<?php
		...
		$img_path = "../media/com_hybridauth/images";
	...
	<tr>
		...
		<td style="text-align: center; width: 33%;">
			<?php echo JText::_( "HybridAuth" ); ?>: <?php echo JText::_( "HYBRIDAUTH_DESC" ); ?>
			<br/>
			<?php echo JText::_( "Copyright" ); ?>: <?php echo HybridAuth::getInstance()->getCopyrightYear(); ?> &copy; <a href="<?php echo $url; ?>" target="_blank">Dioscouri Design</a>
			<br/>
			<?php echo JText::_( "Version" ); ?>: <?php echo HybridAuth::getInstance()->getVersion(); ?>
			<br />
			<?php echo sprintf( JText::_('COM_HYBRIDAUTH_PHP_VERSION_LINE'), HybridAuth::getInstance()->getMinPhp(), HybridAuth::getInstance()->getServerPhp() );?>
		</td>

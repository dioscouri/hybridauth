<?php
/*
* TwitterOAuth modified for providers which the api are Twitter-compatible
* toke the idea from evgeni https://github.com/abraham/twitteroauth/pull/88
*
* V:1.0
*/
...
/**
 * Twitter_Compatible_Client based on Twitter OAuth class
 */
class Twitter_Compatible_Client {
